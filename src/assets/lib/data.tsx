...
export const headerIntroData = {
  title: {
    fr: "Salut, je suis Mercy",
    en: "Hi, I'm Mercy",
  },
  subtitle: "Fullstack Developer ",
  description: {
    fr: "Je suis Mercy, un étudiant en science des données à Queen's University. J'ai compilé toutes les choses cool que je crée ici!",
    en: "I'm Mercy, a Data Science student at Queen's University. I have compiled all the cool things I do here!",
  },
  buttons: [
    {
      name: "Contact",
...
export const navLinks = [
  ...
  { fr: "Qui suis-je?", en: "About me", hash: "#about-me", icon: GoPerson },
  { fr: "Contact", en: "Contact", hash: "#contact", icon: GoMail },
] as const;

export const FooterLinks = [
  { fr: "Empreinte", en: "Imprint", hash: "#imprint", data: <Imprint /> },
...
export const sideBarLeftSocials = [
  {
    link: "https://www.linkedin.com/in/merd/",
    icon: FiLinkedin,
    altimgname: "linkedin",
  },
  {
    link: "https://github.com/sunyshore",
    icon: FiGithub,
    altimgname: "github",
  },
  {
    link: "mailto:19mtmd@queensu.ca",
    icon: FiMail,
    altimgname: "mail",
  },
] as const;
...
export const aboutMeData = {
  title: "Qui suis-je?",
  title_EN: "About me",
  description: "Extraits de code qui me décrivent",
...
export const contactData = {
  ...
  description: {
    fr: "Écrivez-moi un message et je vais vous répondre",
  ...
  inputfields: [
    ...
    },
    {
      ...
      type: "email",
      validation: {
        fr: "Veuillez inscrire votre email",
    ...
    },
    {
      ...
      type: "text",
      validation: {
        fr: "Veuillez inscrire votre sujet",
  ...
  privacyOptIn: {
    checkbox: {
      fr: "J'accepte que mes données personnelles (nom et adresse e-mail) peuvent être utilisées pour me contacter.",
      en: "I agree that my personal data (name and e-mail address) can be used to contact me.",
    },
    description: {
...
export const toastMessages = {
  loadingProject: {
    fr: "🦄 La démo s'ouvriva en quelques moments. Les serveurs se chargent...",
    en: "🦄 The live demo will open shortly. Starting servers...",
  },
  successEmailSent: {
    fr: "🦄 Merci pour votre email. Je vous répondrai dès que je peux",
    en: "🦄 Thank you for your email. I will get back to you as soon as possible",
  },
  failedEmailSent: {
    fr: "🦄 Malheureusement, votre email n'a pas pu être envoyé. Veuillez réessayer plus tard",
    en: "🦄 Unfortunately, your email could not be sent. Please try again later",
  },
